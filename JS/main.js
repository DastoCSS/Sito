const translations = {
    it: {
        ...
        igSub: "Guarda gli ultimi set live, le serate nei club e i contenuti esclusivi direttamente su Instagram.",
        igBtn: "Guarda il Reel su IG",
    ...
    en: {
        ...
        mediaLabel2: "Live, Club & Party",
        igSub: "Check out the latest live sets, club nights, and exclusive content directly on Instagram.",
        igBtn: "Watch Reel on IG",
    ...
    fa: {
        ...
        igSub: "آخرین ست‌های زنده، شب‌های کلاب و محتوای اختصاصی را مستقیماً در اینستاگرام تماشا کنید.",
        igBtn: "مشاهده ریل در اینستاگرام",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    fetch('https://ipapi.co/json/')
        .then(res => res.json())
        .then(data => {
            if (countryToLanguageMap[data.country_code]) {
                applyLanguage(countryToLanguageMap[data.country_code]);
            }
        })
        .catch(() => {});
